...
const projects = [
  {
    ...
    linkedin: "https://www.linkedin.com/in/YOUR_LINKEDIN_HANDLE/", // ← replace with your real URL
    live: null,
    featured: true,
    accent: "#22d3ee",
    icon: "🛒",
...
// SVG placeholder for Admin Dashboard
const AdminDashboardPlaceholder = () => (
  ...
  >
    ...
    <rect x="0" y="0" width="110" height="240" fill="#111827" />
    <rect x="12" y="18" width="86" height="8" rx="4" fill="#a78bfa" opacity="0.7" />
    {[50, 72, 94, 116, 138].map((y, i) => (
      <g key={i}>
        <rect x="12" y={y} width="20" height="20" rx="5" fill={i === 0 ? "#a78bfa22" : "transparent"} />
        <rect x="12" y={y + 6} width="10" height="10" rx="2" fill={i === 0 ? "#a78bfa" : "#374151"} opacity="0.8" />
        <rect x="28" y={y + 7} width="54" height="6" rx="3" fill={i === 0 ? "#c4b5fd" : "#374151"} opacity={i === 0 ? 0.9 : 0.5} />
      </g>
    ))}
    <rect x="118" y="10" width="470" height="28" rx="6" fill="#1f2937" />
    <rect x="128" y="18" width="80" height="10" rx="4" fill="#374151" />
    <rect x="510" y="16" width="30" height="12" rx="6" fill="#a78bfa" opacity="0.5" />
    <rect x="548" y="16" width="30" height="12" rx="6" fill="#374151" opacity="0.5" />
    {[0, 1, 2, 3].map((i) => {
      const x = 118 + i * 120;
      const colors = ["#22d3ee", "#a78bfa", "#34d399", "#fbbf24"];
      return (
        <g key={i}>
          <rect x={x} y="48" width="112" height="58" rx="8" fill="#1f2937" />
          <rect x={x + 8} y="56" width="20" height="20" rx="5" fill={`${colors[i]}22`} />
          <rect x={x + 10} y="60" width="12" height="12" rx="3" fill={colors[i]} opacity="0.8" />
          <rect x={x + 8} y="82" width="70" height="8" rx="3" fill={colors[i]} opacity="0.9" />
          <rect x={x + 8} y="96" width="50" height="5" rx="2" fill="#4b5563" />
        </g>
      );
    })}
    <rect x="118" y="116" width="280" height="112" rx="8" fill="#1f2937" />
    <rect x="128" y="124" width="80" height="8" rx="3" fill="#e5e7eb" opacity="0.5" />
    {[
      { h: 40, c: "#a78bfa" },
      { h: 60, c: "#a78bfa" },
      { h: 35, c: "#a78bfa" },
      ...
      <rect key={i} x={136 + i * 34} y={210 - bar.h} width="22" height={bar.h} rx="4" fill={bar.c} opacity="0.75" />
    ))}
    <line x1="128" y1="210" x2="390" y2="210" stroke="#374151" strokeWidth="1" />
    <rect x="406" y="116" width="182" height="112" rx="8" fill="#1f2937" />
    <rect x="416" y="124" width="70" height="7" rx="3" fill="#e5e7eb" opacity="0.5" />
    {[0, 1, 2, 3, 4].map((i) => (
      <g key={i}>
        <rect x="416" y={140 + i * 17} width="10" height="10" rx="2" fill="#374151" />
        <rect x="432" y={143 + i * 17} width="80" height="5" rx="2" fill="#4b5563" />
        <rect x="536" y={143 + i * 17} width="40" height="5" rx="2" fill={i % 2 === 0 ? "#34d399" : "#fbbf24"} opacity="0.7" />
      </g>
    ))}
    {[148, 170, 192].map((y) => (
      <line key={y} x1="128" y1={y} x2="390" y2={y} stroke="#374151" strokeWidth="0.5" strokeDasharray="4 4" />
    ))}
  </svg>
);
...
const ImageCarousel = ({ images }) => {
  ...
  return (
    ...
    >
      {/* ↓ HEIGHT increased to 480px; objectPosition changed to "center" for full image */}
        ...
        {images.map((src, i) => (
          <img
            ...
            style={{
              ...
              height: "100%",
              objectFit: "cover",
              objectPosition: "center", // ← was "top", now "center" shows full image
  ...
  return (
    <>
      <style>{`
        ...
        .project-card-link.linkedin-link:hover {
          color: #0a66c2;
        ...
        .project-image-wrapper:hover svg {
          transform: scale(1.03);
        }
        .project-image-overlay {
          position: absolute;
          inset: 0;
          background: linear-gradient(to bottom, transparent 70%, rgba(10, 15, 30, 0.5) 100%);
          pointer-events: none;
        }
        ...
        {featured && (
          ...
          >
            ...
            {featured.images && featured.images.length > 0 && (
              <ImageCarousel images={featured.images} />
            )}
            ...
            >
              ...
              <div style={{ display: "flex", gap: "10px", flexShrink: 0 }}>
                ...
                {/* ← NEW: LinkedIn link next to GitHub */}
                {featured.linkedin && (
                  <a
                    href={featured.linkedin}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="project-card-link linkedin-link"
                  >
                    <LinkedInIcon />
                    LinkedIn
                  </a>
          ...
          {rest.map((project, i) => (
            ...
            >
              ...
              >
                ...
                {/* ← NEW: LinkedIn link on Admin Dashboard (and any card with linkedin prop) */}
                {project.linkedin && (
                  <a
